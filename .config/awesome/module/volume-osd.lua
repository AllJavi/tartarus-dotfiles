...
local osd_header = wibox.widget {
	markup = '<span color="#d4be98">Volume</span>',
	font = 'JetBrains Mono Bold Nerd Font Complete 12',
	align = 'left',
	valign = 'center',
...
local osd_value = wibox.widget {
	markup = '<span color="#d4be98">0%</span>',
	font = 'JetBrains Mono Bold Nerd Font Complete 12',
	align = 'center',
	valign = 'center',
	widget = wibox.widget.textbox
...
vol_osd_slider:connect_signal(
	...
	function()
		...
		osd_value.markup = '<span color="#d4be98">' .. volume_level .. '%</span>' 
...
awesome.connect_signal(
	'module::volume_osd:toogle', 
	function(bool)
		local focused = awful.screen.focused()
		if focused.volume_osd_overlay.visible then
			if hide_osd.started then
				hide_osd:stop()
			end
			focused.volume_osd_overlay.visible = false
